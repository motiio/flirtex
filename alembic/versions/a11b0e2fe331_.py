...
Revision ID: a11b0e2fe331
Revises: 
Create Date: 2023-05-18 01:12:09.072378
...
def upgrade() -> None:
    ...
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['region'], ['core.region.id'], ),
    sa.PrimaryKeyConstraint('id'),
    schema='core'
    )
    ...
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['user'], ['core.user.id'], ),
    sa.PrimaryKeyConstraint('id'),
    schema='core'
    )
    ...
    sa.Column('gender', sa.Enum('male', 'female', 'unknown', name='genderenum', schema='core'), nullable=True),
    sa.Column('looking_gender', sa.Enum('male', 'female', 'unknown', name='genderenum', schema='core'), nullable=True),
    sa.Column('is_active', sa.Boolean(), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['city'], ['core.city.id'], ),
    sa.ForeignKeyConstraint(['owner'], ['core.user.id'], ),
    sa.PrimaryKeyConstraint('id'),
    schema='core'
    )
    ...
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['interest_id'], ['core.interest.id'], ),
    sa.ForeignKeyConstraint(['profile_id'], ['core.profile.id'], ),
    sa.PrimaryKeyConstraint('id'),
    schema='core'
    )
    ...
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['profile'], ['core.profile.id'], ),
    sa.PrimaryKeyConstraint('id'),
    schema='core'
    )
