...
def downgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("profile_id", sa.UUID(), autoincrement=False, nullable=False),
        sa.Column(
            "displaying_order", sa.INTEGER(), autoincrement=False, nullable=False
        ),
        sa.Column(
            "status",
            postgresql.ENUM(
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["source_profile"],
            ["core.profile.id"],
            name="like_source_profile_fkey",
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["target_profile"],
            ["core.profile.id"],
            name="like_target_profile_fkey",
            ondelete="CASCADE",
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["owner_id"], ["core.user.id"], name="profile_owner_id_fkey"
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["profile_id"],
            ["core.profile.id"],
            name="save_profile_id_fkey",
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["saved_profile_id"],
            ["core.profile.id"],
            name="save_saved_profile_id_fkey",
            ondelete="CASCADE",
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["user"], ["core.user.id"], name="refresh_token_user_fkey"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "tg_username", sa.VARCHAR(length=32), autoincrement=False, nullable=True
        ),
        sa.Column(
            "tg_first_name", sa.VARCHAR(length=32), autoincrement=False, nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["profile_1"],
            ["core.profile.id"],
            name="match_profile_1_fkey",
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["profile_2"],
            ["core.profile.id"],
            name="match_profile_2_fkey",
            ondelete="CASCADE",
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["source_profile"],
            ["core.profile.id"],
            name="skip_source_profile_fkey",
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["target_profile"],
            ["core.profile.id"],
            name="skip_target_profile_fkey",
            ondelete="CASCADE",
        ),
