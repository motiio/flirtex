...
Revision ID: 204350c470ac
Revises: ab674469eccc
Create Date: 2024-01-07 09:49:18.747575
...
revision = '204350c470ac'
down_revision = 'ab674469eccc'
branch_labels = None
depends_on = None
...
def downgrade() -> None:
    ...
    sa.Column('created_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=False),
    sa.Column('updated_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['interest_id'], ['core.interest.id'], name='profile_interests_interest_id_fkey', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['profile_id'], ['core.profile.id'], name='profile_interests_profile_id_fkey', ondelete='CASCADE'),
    ...
    sa.Column('id', sa.UUID(), autoincrement=False, nullable=False),
    sa.Column('profile_id', sa.UUID(), autoincrement=False, nullable=False),
    sa.Column('displaying_order', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.Column('status', postgresql.ENUM('approved', 'processing', 'rejected', name='photoprocessstatusenum', schema='core'), autoincrement=False, nullable=False),
    sa.Column('status_description', sa.VARCHAR(length=32), autoincrement=False, nullable=True),
    ...
    sa.Column('created_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=False),
    sa.Column('updated_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['profile_id'], ['core.profile.id'], name='photo_profile_id_fkey', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id', name='photo_pkey'),
    sa.UniqueConstraint('url', name='photo_url_key'),
    schema='core'
    )
    op.create_table('like',
    sa.Column('id', sa.UUID(), autoincrement=False, nullable=False),
    sa.Column('source_profile', sa.UUID(), autoincrement=False, nullable=False),
    sa.Column('target_profile', sa.UUID(), autoincrement=False, nullable=False),
    sa.Column('created_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=False),
    sa.Column('updated_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['source_profile'], ['core.profile.id'], name='like_source_profile_fkey', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['target_profile'], ['core.profile.id'], name='like_target_profile_fkey', ondelete='CASCADE'),
    ...
    sa.Column('name', sa.VARCHAR(length=32), autoincrement=False, nullable=False),
    sa.Column('bio', sa.VARCHAR(length=600), autoincrement=False, nullable=True),
    sa.Column('birthdate', sa.DATE(), autoincrement=False, nullable=False),
    sa.Column('gender', postgresql.ENUM('male', 'female', name='genderenum', schema='core'), autoincrement=False, nullable=False),
    sa.Column('location', geoalchemy2.types.Geometry(geometry_type='POINT', srid=4326, from_text='ST_GeomFromEWKT', name='geometry', _spatial_index_reflected=True), autoincrement=False, nullable=True),
    sa.Column('created_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=False),
    sa.Column('updated_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['owner_id'], ['core.user.id'], name='profile_owner_id_fkey'),
    sa.PrimaryKeyConstraint('id', name='profile_pkey'),
    schema='core',
    postgresql_ignore_search_path=False
    )
    op.create_index('idx_profile_location', 'profile', ['location'], unique=False, schema='core', postgresql_using='gist')
    op.create_table('save',
    sa.Column('id', sa.UUID(), autoincrement=False, nullable=False),
    sa.Column('profile_id', sa.UUID(), autoincrement=False, nullable=False),
    sa.Column('saved_profile_id', sa.UUID(), autoincrement=False, nullable=False),
    sa.Column('created_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=False),
    sa.Column('updated_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['profile_id'], ['core.profile.id'], name='save_profile_id_fkey', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['saved_profile_id'], ['core.profile.id'], name='save_saved_profile_id_fkey', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id', name='save_pkey'),
    schema='core'
    )
    op.create_table('filter',
    sa.Column('id', sa.UUID(), autoincrement=False, nullable=False),
    sa.Column('looking_gender', postgresql.ENUM('nevermind', 'male', 'female', name='lookinggenderenum', schema='core'), autoincrement=False, nullable=False),
    ...
    sa.Column('max_distance', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.Column('profile_id', sa.UUID(), autoincrement=False, nullable=False),
    sa.Column('created_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=False),
    sa.Column('updated_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['profile_id'], ['core.profile.id'], name='filter_profile_id_fkey', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id', name='filter_pkey'),
    schema='core'
    )
    ...
    sa.Column('created_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=False),
    sa.Column('updated_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['user'], ['core.user.id'], name='refresh_token_user_fkey'),
    ...
    sa.Column('tg_username', sa.VARCHAR(length=32), autoincrement=False, nullable=True),
    sa.Column('tg_first_name', sa.VARCHAR(length=32), autoincrement=False, nullable=True),
    sa.Column('tg_last_name', sa.VARCHAR(), autoincrement=False, nullable=True),
    sa.Column('tg_is_premium', sa.BOOLEAN(), autoincrement=False, nullable=True),
    sa.Column('tg_language_code', sa.VARCHAR(), autoincrement=False, nullable=True),
    sa.Column('created_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=False),
    sa.Column('updated_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=False),
    sa.PrimaryKeyConstraint('id', name='user_pkey'),
    sa.UniqueConstraint('tg_id', name='user_tg_id_key'),
    sa.UniqueConstraint('tg_username', name='user_tg_username_key'),
    schema='core',
    postgresql_ignore_search_path=False
    )
    ...
    sa.Column('id', sa.UUID(), autoincrement=False, nullable=False),
    sa.Column('profile_1', sa.UUID(), autoincrement=False, nullable=False),
    sa.Column('profile_2', sa.UUID(), autoincrement=False, nullable=False),
    sa.Column('created_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=False),
    sa.Column('updated_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['profile_1'], ['core.profile.id'], name='match_profile_1_fkey', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['profile_2'], ['core.profile.id'], name='match_profile_2_fkey', ondelete='CASCADE'),
    ...
    sa.Column('created_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=False),
    sa.Column('updated_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['source_profile'], ['core.profile.id'], name='skip_source_profile_fkey', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['target_profile'], ['core.profile.id'], name='skip_target_profile_fkey', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id', name='skip_pkey'),
    schema='core'
    )
